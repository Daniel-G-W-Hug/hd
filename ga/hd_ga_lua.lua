...
print()
print("dot(vec3d.new(-3,5,7),vec3d.new(2,-5,12)):",
       dot(vec3d.new(-3,5,7),vec3d.new(2,-5,12)))
print("wdg(vec3d.new(-3,5,7),vec3d.new(2,-5,12)):",
       wdg(vec3d.new(-3,5,7),vec3d.new(2,-5,12)))
print("vec3d.new(-3,5,7)*vec3d.new(2,-5,12):",vec3d.new(-3,5,7)*vec3d.new(2,-5,12))
print()
print("wdg(vec3d.new(-3,5,7),bivec3d.new(2,3,4)):",
       wdg(vec3d.new(-3,5,7),bivec3d.new(2,3,4)))
print()
print("wdg(bivec3d.new(2,3,4),vec3d.new(-3,5,7)):",
       wdg(bivec3d.new(2,3,4),vec3d.new(-3,5,7)))
print()
print("vec3d.new(-3,5,7)*bivec3d.new(2,3,4)):",
       vec3d.new(-3,5,7)*bivec3d.new(2,3,4))
print()
print("bivec3d.new(2,3,4)*vec3d.new(-3,5,7)):",
       bivec3d.new(2,3,4)*vec3d.new(-3,5,7))
print()
print("bivec3d.new(2,3,4)*bivec3d.new(-3,5,7)):",
       bivec3d.new(2,3,4)*bivec3d.new(-3,5,7))
print()
...
print()
print("mvec3d_e.new(2,1,2,3)*mvec3d_e.new(1,2,3,4):",
       mvec3d_e.new(2,1,2,3)*mvec3d_e.new(1,2,3,4))
print()
print("mvec3d_u.new(2,1,2,3)*mvec3d_u.new(1,2,3,4):",
       mvec3d_u.new(2,1,2,3)*mvec3d_u.new(1,2,3,4))
print()
print("mvec3d_e.new(2,1,2,3)*mvec3d_u.new(1,2,3,4):",
       mvec3d_e.new(2,1,2,3)*mvec3d_u.new(1,2,3,4))
print()
print("mvec3d_u.new(2,1,2,3)*mvec3d_e.new(1,2,3,4):",
       mvec3d_u.new(2,1,2,3)*mvec3d_e.new(1,2,3,4))
print()
print("mvec3d.new(1,2,-5,12,2,3,4,1)*mvec3d.new(2,0,0,0,1,2,3,0):",
       mvec3d.new(1,2,-5,12,2,3,4,1)*mvec3d.new(2,0,0,0,1,2,3,0))
print("mvec3d.new(1,2,-5,12,2,3,4,1)*mvec3d_e.new(2,1,2,3):",
       mvec3d.new(1,2,-5,12,2,3,4,1)*mvec3d_e.new(2,1,2,3))
print()
print("mvec3d_e.new(2,1,2,3)*bivec3d.new(2,3,4):",
       mvec3d_e.new(2,1,2,3)*bivec3d.new(2,3,4))
print()
print("bivec3d.new(2,3,4)*mvec3d_e.new(2,1,2,3):",
       bivec3d.new(2,3,4)*mvec3d_e.new(2,1,2,3))
print()
print("pscalar3d.new(1)*pscalar3d.new(1):",
       pscalar3d.new(1)*pscalar3d.new(1))
print("pscalar3d.new(1)*rev(pscalar3d.new(1)):",
       pscalar3d.new(1)*rev(pscalar3d.new(1)))
print()
print()
...
do
    local theta = math.pi/10.0*i
    print("theta:",theta, "rotor(bv,theta):",
          rotor(bv,theta),"rotated:",
